...
-+
	 ...
	 * Date(), false, 20)); todos.add(new Todo(++idCounter, "MyTodos", "Sport 2",
	 * new Date(), false, 30)); todos.add(new Todo(++idCounter, "MyTodos",
	 * "Learn Englisch", new Date(), false, 40)); todos.add(new Todo(++idCounter,
	 * "MyTodos", "Schwimmen", new Date(), false, 50)); }
	 * 
	 ...
	 * todo.setId(++idCounter); todos.add(todo); } else { deleteById(todo.getId());
	 * todos.add(todo); } return todo; }
	 * 
